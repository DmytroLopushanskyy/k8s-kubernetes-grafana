...
To make the volumes work run correctly on my M1 Mac, I needed to mount the home folder:
`minikube mount /Users:/Users`


Additionally, I needed to tweak security config for Prometheus, otherwise it refused to start.
